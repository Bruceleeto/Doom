...
idCVar r_skipSpecular( "r_skipSpecular", "1", CVAR_RENDERER | CVAR_BOOL | CVAR_ROM, "specular removed" );
idCVar r_skipBump( "r_skipBump", "1", CVAR_RENDERER | CVAR_BOOL | CVAR_ROM, "bump mapping removed" );
